...
**Devloop** 是 AI 时代开发者的个人反馈循环，帮你持续成长。它会扫描你的代码、Claude 对话、git 记录和上线的产品，在 7 个能力维度上给你画像，再从 50+ 个权威信源中，为你最大的短板挑一篇真正值得读的内容。
...
- **不是课程。** 没有大纲，不上课。它告诉你该往哪看，不规定你怎么学。
- **不是 newsletter。** 每条推荐都是按你自己的工作挑的，不是群发给一堆人的广播。
- **不是代码审查工具。** 它找的是你能力上的盲区，不是代码里的 bug。
- **不适合还没动手的人。** 如果你还在跟着教程走，那就没有真实的工作可以拿来分析。
...
| --------------------------------------------- | -------------------------------------------- |
| AI 工具每周都在变，根本追不上                 | 每次运行给你一条推荐，从 50+ 信源里精准匹配  |
| 觉得自己不会做增长，但不知道从哪开始          | 一张能力图谱，证据全来自你自己的代码和对话   |
| 刷 HN、刷 Twitter、看了一堆，但感觉没什么长进 | 推的内容跟你的项目直接相关，不是泛泛的攻略帖 |
